...
import tuan.entity.$OrderDTO;
import java.util.Date;
import java.util.List;
import javax.persistence.Query;
import tuan.entity.Admin;
import tuan.entity.Car;
import tuan.entity.CarOrder;
import tuan.entity.CarOrderDetail;
 ...
 * @author Anh Tuan
 */
@Stateful(name = "TuanStatefulRemote",mappedName = "TuanStatefulRemote")
public class TuanStateful implements TuanStatefulRemote, TuanStatefulLocal {
