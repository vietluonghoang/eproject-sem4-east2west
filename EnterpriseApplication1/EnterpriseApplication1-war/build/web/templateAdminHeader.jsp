                ...
                %><ul class="current"><%                    } else {
                    ...
                    %><ul class="current"><%                    } else {
                        ...
                        %><ul class="current"><%                    } else {
                            ...
                            %><ul class="current"><%                    } else {
                                %><ul class="select"><%                        }
                                    %><li><a href="#nogo"><b>Tour</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                                        <div class="select_sub show">
                                            <ul class="sub">
                                                <%if ($page.equals("insert")) {
                                                ...
                                                %><li><%                                        }
                                                    %>
                                                    <a href="AinsertTour.jsp" >New Tour</a>
                                                </li>
                                                <%if ($page.equals("search")) {
                                                %><li class="sub_show"><%                                    } else {
                                                %><li><%                                        }
                                                    %>
                                                    <a href="AdminTourSearch.jsp" >All Tours</a></li>
                                            </ul>
                                        </div>
                                        <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                                    </li>
                                        ...
                                        %><li><a href="#nogo"><b>Report</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                            ...
                                            <div class="select_sub show">
                                                <ul class="sub">
                                                    ...
                                                    %><li><%                                        }
                                                        %>
                                                        <a href="carReportSearch.jsp" >Car report</a>
                                                    </li>
                                                    <%if ($page.equals("tour")) {
                                                    %><li class="sub_show"><%                                    } else {
                                                    %><li><%                                        }
                                                        %>
                                                        <a href="AdminTourReport.jsp" >Tour report</a></li>
                                                </ul>
                                            </div>
                                            <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                                        </li>
