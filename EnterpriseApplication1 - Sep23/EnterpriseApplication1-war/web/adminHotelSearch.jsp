    ...
    <head>
 	...
 	$('#menuTable').tablePagination(options);
        ...
        if(request.getAttribute("INFO") == null) {
            result = (Hotel[])statelessRemote.searchHotel("SELECT h FROM Hotel h WHERE h.isDeleted = false");
        } else {
            ...
            <tbody>
                ...
                <tr align="center">
                    ...
                    <td align="center"><form action="adminHotelDescription.jsp" method="post">
                        ...
                        <form action="adminHotelUpdate.jsp" method="post">
                            <input type="hidden" name="$hotelID" value="<%=result[i].getHotelID() %>" />
                            <input type="submit" name="action" value="update hotel" id="btUpdate" />
                        </form>
                        <form action="ActionServlet" method="post" onsubmit=
                            "return confirm(
